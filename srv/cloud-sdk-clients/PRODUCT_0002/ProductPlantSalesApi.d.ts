...
export declare class ProductPlantSalesApi<
...
> implements EntityApi<ProductPlantSales<DeSerializersT>, DeSerializersT>
{
  ...
  static _privateFactory<
    DeSerializersT extends DeSerializers = DefaultDeSerializers
  >(deSerializers?: DeSerializersT): ProductPlantSalesApi<DeSerializersT>;
  private navigationPropertyFields;
  _addNavigationProperties(
    linkedApis: [ProductApi<DeSerializersT>, ProductPlantApi<DeSerializersT>]
  ): this;
  entityConstructor: typeof ProductPlantSales;
  ...
  get fieldBuilder(): FieldBuilder<typeof ProductPlantSales, DeSerializersT>;
  private _schema?;
  get schema(): {
