 ...
 */
export class ProductChangeMasterRequestBuilder<
...
> extends RequestBuilder<ProductChangeMaster<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<ProductChangeMaster<T>, T> {
    return new GetAllRequestBuilder<ProductChangeMaster<T>, T>(this.entityApi);
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<ProductChangeMaster<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<ProductChangeMaster<T>, T>(
      this.entityApi,
      {
        Product: product,
  ...
  update(
    ...
    return new UpdateRequestBuilder<ProductChangeMaster<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<ProductChangeMaster<T>, T>(
      this.entityApi,
      productOrEntity instanceof ProductChangeMaster
        ? productOrEntity
        : {
