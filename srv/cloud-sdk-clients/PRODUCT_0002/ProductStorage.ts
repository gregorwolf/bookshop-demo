  ...
  implements ProductStorageType<T>
{
   ...
   */
  static override _entityName = 'ProductStorage';
  /**
   ...
   * Maximum length: 2.
   */
  declare storageConditions: DeserializedType<T, 'Edm.String'>;
  /**
   * Prod Temperature Condition Code.
   * Maximum length: 2.
   */
  declare prodTemperatureConditionCode: DeserializedType<T, 'Edm.String'>;
  /**
   * Hazardous Product.
   * Maximum length: 18.
   */
  declare hazardousProduct: DeserializedType<T, 'Edm.String'>;
  /**
   * Nmbr Of Gr Or Gi Slips To Print Qty.
   */
  declare nmbrOfGrOrGiSlipsToPrintQty: DeserializedType<T, 'Edm.Decimal'>;
  /**
   * Label Type.
   * Maximum length: 2.
   */
  declare labelType: DeserializedType<T, 'Edm.String'>;
  /**
   * Label Form.
   * Maximum length: 2.
   */
  declare labelForm: DeserializedType<T, 'Edm.String'>;
  /**
   * Min Remaining Shelf Life.
   */
  declare minRemainingShelfLife: DeserializedType<T, 'Edm.Decimal'>;
  /**
   * Product Expiration Date Type.
   * Maximum length: 1.
   */
  declare productExpirationDateType: DeserializedType<T, 'Edm.String'>;
  /**
   * Storage Bin Instruction.
   * Maximum length: 2.
   */
  declare storageBinInstruction: DeserializedType<T, 'Edm.String'>;
  /**
   * Shelf Life Expiration Date Period.
   * Maximum length: 1.
   */
  declare shelfLifeExpirationDatePeriod: DeserializedType<T, 'Edm.String'>;
  /**
   * Shelf Life Exprtn Date Rndng Rule.
   * Maximum length: 1.
   */
  declare shelfLifeExprtnDateRndngRule: DeserializedType<T, 'Edm.String'>;
  /**
   * Total Shelf Life Storage Percent.
   */
  declare totalShelfLifeStoragePercent: DeserializedType<T, 'Edm.Decimal'>;
  /**
   * Total Shelf Life.
   */
  declare totalShelfLife: DeserializedType<T, 'Edm.Decimal'>;
  /**
   * Base Unit.
   * Maximum length: 3.
   */
