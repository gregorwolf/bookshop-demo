 ...
 */
export class ProductPlantQualityManagementRequestBuilder<
...
> extends RequestBuilder<ProductPlantQualityManagement<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<ProductPlantQualityManagement<T>, T> {
    return new GetAllRequestBuilder<ProductPlantQualityManagement<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<ProductPlantQualityManagement<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<ProductPlantQualityManagement<T>, T>(
      this.entityApi,
      {
        Product: product,
        Plant: plant
  ...
  update(
    ...
    return new UpdateRequestBuilder<ProductPlantQualityManagement<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<ProductPlantQualityManagement<T>, T>(
      this.entityApi,
      productOrEntity instanceof ProductPlantQualityManagement
        ? productOrEntity
        : {
