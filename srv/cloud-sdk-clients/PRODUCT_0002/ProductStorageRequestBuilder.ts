 ...
 */
export class ProductStorageRequestBuilder<
...
> extends RequestBuilder<ProductStorage<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<ProductStorage<T>, T> {
    return new GetAllRequestBuilder<ProductStorage<T>, T>(this.entityApi);
  }
   ...
   */
  create(
    entity: ProductStorage<T>
  ): CreateRequestBuilder<ProductStorage<T>, T> {
    return new CreateRequestBuilder<ProductStorage<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<ProductStorage<T>, T>(this.entityApi, {
      Product: product
    });
  }
  ...
  update(
    entity: ProductStorage<T>
  ): UpdateRequestBuilder<ProductStorage<T>, T> {
    return new UpdateRequestBuilder<ProductStorage<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(productOrEntity: any): DeleteRequestBuilder<ProductStorage<T>, T> {
    return new DeleteRequestBuilder<ProductStorage<T>, T>(
      this.entityApi,
      productOrEntity instanceof ProductStorage
        ? productOrEntity
