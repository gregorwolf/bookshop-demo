 ...
 */
export class ProductPlantInspTypeSettingRequestBuilder<
...
> extends RequestBuilder<ProductPlantInspTypeSetting<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<ProductPlantInspTypeSetting<T>, T> {
    return new GetAllRequestBuilder<ProductPlantInspTypeSetting<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<ProductPlantInspTypeSetting<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<ProductPlantInspTypeSetting<T>, T>(
      this.entityApi,
      {
  ...
  update(
    ...
    return new UpdateRequestBuilder<ProductPlantInspTypeSetting<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    inspectionLotTypeOrEntity: any,
    product?: string,
    plant?: string
  ): DeleteRequestBuilder<ProductPlantInspTypeSetting<T>, T> {
    return new DeleteRequestBuilder<ProductPlantInspTypeSetting<T>, T>(
      this.entityApi,
      inspectionLotTypeOrEntity instanceof ProductPlantInspTypeSetting
