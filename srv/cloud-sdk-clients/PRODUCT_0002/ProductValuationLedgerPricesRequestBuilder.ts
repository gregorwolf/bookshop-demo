 ...
 */
export class ProductValuationLedgerPricesRequestBuilder<
...
> extends RequestBuilder<ProductValuationLedgerPrices<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<ProductValuationLedgerPrices<T>, T> {
    return new GetAllRequestBuilder<ProductValuationLedgerPrices<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<ProductValuationLedgerPrices<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<ProductValuationLedgerPrices<T>, T>(
      this.entityApi,
      {
        Product: product,
  ...
  update(
    ...
    return new UpdateRequestBuilder<ProductValuationLedgerPrices<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<ProductValuationLedgerPrices<T>, T>(
      this.entityApi,
      productOrEntity instanceof ProductValuationLedgerPrices
        ? productOrEntity
        : {
