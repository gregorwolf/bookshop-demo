 ...
 */
export class ProdSalesDeliverySalesTaxRequestBuilder<
...
> extends RequestBuilder<ProdSalesDeliverySalesTax<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<ProdSalesDeliverySalesTax<T>, T> {
    return new GetAllRequestBuilder<ProdSalesDeliverySalesTax<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<ProdSalesDeliverySalesTax<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<ProdSalesDeliverySalesTax<T>, T>(
      this.entityApi,
      {
        Product: product,
        Country: country,
  ...
  update(
    ...
    return new UpdateRequestBuilder<ProdSalesDeliverySalesTax<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<ProdSalesDeliverySalesTax<T>, T>(
      this.entityApi,
      productOrEntity instanceof ProdSalesDeliverySalesTax
        ? productOrEntity
        : {
