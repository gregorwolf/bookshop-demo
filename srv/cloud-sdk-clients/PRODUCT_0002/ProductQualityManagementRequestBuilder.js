...
exports.ProductQualityManagementRequestBuilder = void 0;
/*
 ...
 */
class ProductQualityManagementRequestBuilder extends odata_v4_1.RequestBuilder {
    /**
    ...
    delete(productOrEntity) {
        return new odata_v4_1.DeleteRequestBuilder(this.entityApi, productOrEntity instanceof ProductQualityManagement_1.ProductQualityManagement
            ? productOrEntity
            : { Product: productOrEntity });
    }
}
exports.ProductQualityManagementRequestBuilder = ProductQualityManagementRequestBuilder;
//# sourceMappingURL=ProductQualityManagementRequestBuilder.js.map