 ...
 */
export class ProductEwmWarehouseRequestBuilder<
...
> extends RequestBuilder<ProductEwmWarehouse<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<ProductEwmWarehouse<T>, T> {
    return new GetAllRequestBuilder<ProductEwmWarehouse<T>, T>(this.entityApi);
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<ProductEwmWarehouse<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<ProductEwmWarehouse<T>, T>(
      this.entityApi,
      {
        Product: product,
  ...
  update(
    ...
    return new UpdateRequestBuilder<ProductEwmWarehouse<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<ProductEwmWarehouse<T>, T>(
      this.entityApi,
      productOrEntity instanceof ProductEwmWarehouse
        ? productOrEntity
        : {
