 ...
 */
export class ProductQualityManagementRequestBuilder<
...
> extends RequestBuilder<ProductQualityManagement<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<ProductQualityManagement<T>, T> {
    return new GetAllRequestBuilder<ProductQualityManagement<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<ProductQualityManagement<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<ProductQualityManagement<T>, T>(
      this.entityApi,
      { Product: product }
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<ProductQualityManagement<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<ProductQualityManagement<T>, T>(
      this.entityApi,
      productOrEntity instanceof ProductQualityManagement
        ? productOrEntity
