 ...
 */
export class ProductPlantForecastRequestBuilder<
...
> extends RequestBuilder<ProductPlantForecast<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<ProductPlantForecast<T>, T> {
    return new GetAllRequestBuilder<ProductPlantForecast<T>, T>(this.entityApi);
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<ProductPlantForecast<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<ProductPlantForecast<T>, T>(
      this.entityApi,
      {
        Product: product,
        Plant: plant
  ...
  update(
    ...
    return new UpdateRequestBuilder<ProductPlantForecast<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<ProductPlantForecast<T>, T>(
      this.entityApi,
      productOrEntity instanceof ProductPlantForecast
        ? productOrEntity
        : {
