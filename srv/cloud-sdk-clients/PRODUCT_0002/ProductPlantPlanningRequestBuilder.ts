 ...
 */
export class ProductPlantPlanningRequestBuilder<
...
> extends RequestBuilder<ProductPlantPlanning<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<ProductPlantPlanning<T>, T> {
    return new GetAllRequestBuilder<ProductPlantPlanning<T>, T>(this.entityApi);
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<ProductPlantPlanning<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<ProductPlantPlanning<T>, T>(
      this.entityApi,
      {
        Product: product,
        Plant: plant
  ...
  update(
    ...
    return new UpdateRequestBuilder<ProductPlantPlanning<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<ProductPlantPlanning<T>, T>(
      this.entityApi,
      productOrEntity instanceof ProductPlantPlanning
        ? productOrEntity
        : {
