...
> extends RequestBuilder<ProductProcurement<T>, T> {
  ...
  delete(productOrEntity: any): DeleteRequestBuilder<ProductProcurement<T>, T> {
    return new DeleteRequestBuilder<ProductProcurement<T>, T>(
      this.entityApi,
      productOrEntity instanceof ProductProcurement
        ? productOrEntity
