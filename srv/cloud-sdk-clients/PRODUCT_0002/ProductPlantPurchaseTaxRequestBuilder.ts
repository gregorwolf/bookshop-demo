 ...
 */
export class ProductPlantPurchaseTaxRequestBuilder<
...
> extends RequestBuilder<ProductPlantPurchaseTax<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<ProductPlantPurchaseTax<T>, T> {
    return new GetAllRequestBuilder<ProductPlantPurchaseTax<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<ProductPlantPurchaseTax<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<ProductPlantPurchaseTax<T>, T>(
      this.entityApi,
      {
        Product: product,
        Plant: plant,
  ...
  update(
    ...
    return new UpdateRequestBuilder<ProductPlantPurchaseTax<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<ProductPlantPurchaseTax<T>, T>(
      this.entityApi,
      productOrEntity instanceof ProductPlantPurchaseTax
        ? productOrEntity
        : {
