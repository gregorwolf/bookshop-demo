 ...
 */
export class ProductValuationAccountingRequestBuilder<
...
> extends RequestBuilder<ProductValuationAccounting<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<ProductValuationAccounting<T>, T> {
    return new GetAllRequestBuilder<ProductValuationAccounting<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<ProductValuationAccounting<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<ProductValuationAccounting<T>, T>(
      this.entityApi,
      {
        Product: product,
  ...
  update(
    ...
    return new UpdateRequestBuilder<ProductValuationAccounting<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<ProductValuationAccounting<T>, T>(
      this.entityApi,
      productOrEntity instanceof ProductValuationAccounting
        ? productOrEntity
        : {
