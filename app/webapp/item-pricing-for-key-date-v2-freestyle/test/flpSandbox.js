		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Item Pricing",
									"targetURL": "#itempricingforkeydatev2freestyle-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"itempricingforkeydatev2freestyle-display": {
								"semanticObject": "itempricingforkeydatev2freestyle",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=itempricingforkeydatev2freestyle",
									"url": sap.ui.require.toUrl("itempricingforkeydatev2freestyle")
								}
							}
						}
					}
