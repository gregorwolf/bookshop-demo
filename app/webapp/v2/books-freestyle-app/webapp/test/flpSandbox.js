		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Books Freestyle",
									"targetURL": "#v2booksfreestyleapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"v2booksfreestyleapp-display": {
								"semanticObject": "v2booksfreestyleapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=v2.booksfreestyleapp",
									"url": sap.ui.require.toUrl("v2/booksfreestyleapp")
								}
							}
						}
					}
