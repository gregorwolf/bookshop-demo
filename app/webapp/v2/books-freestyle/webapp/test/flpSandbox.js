		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Browse Books Freestyle",
									"targetURL": "#BrowseBooksFreestyle-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"BrowseBooksFreestyle-display": {
								"semanticObject": "BrowseBooksFreestyle",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=v2.booksfreestyle",
									"url": sap.ui.require.toUrl("v2/booksfreestyle")
								}
							}
						}
					}
