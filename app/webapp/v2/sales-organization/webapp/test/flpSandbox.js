		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#v2salesorganization-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"v2salesorganization-display": {
								"semanticObject": "v2salesorganization",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=v2.salesorganization",
									"url": sap.ui.require.toUrl("v2/salesorganization")
								}
							}
						}
					}
